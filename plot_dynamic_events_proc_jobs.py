...
for i in range(len(utilization)):
    filename = 'Results/Proc_Job' + str(utilization[i]) + '_' + str(due_date_settings[i]) + '.csv'
    filename1 = 'Results/Proc_Job' + str(utilization[i]) + '_' + str(due_date_settings[i]) + '_Static' + '.csv'
    ...
    ax[0, 0].set_xlabel("Processing Job Percentage/ Processing Time Increase")
    ...
    ax[0, 1].set_xlabel("Processing Job Percentage/ Processing Time Increase")
    ...
    ax[0, 2].set_xlabel("Processing Job Percentage/ Processing Time Increase")
    ...
    ax[1, 0].set_xlabel("Processing Job Percentage/ Processing Time Increase")
    ...
    ax[1, 1].set_xlabel("Processing Job Percentage/ Processing Time Increase")
...
plt.setp(ax, xticks=range(8), xticklabels=['0.05/0.05', '0.05/0.10', '0.05/0.15', '0.05/0.20', '0.10/0.05', '0.10/0.10', '0.10/0.15', '0.10/0.20'])
fig.suptitle('Increase in Processing Time', fontsize=24)
